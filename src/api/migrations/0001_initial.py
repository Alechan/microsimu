# Generated by Django 3.1.3 on 2020-11-09 02:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weight_constraint_1', api.models.fields.ParameterFloatField(blank=True, default=6.0, model_parameter=api.std_lib.lawm.general_parameters.WeightConstraint1, validators=[api.models.validators.MaxValueParameterValidator(14), api.models.validators.MinValueParameterValidator(1)])),
                ('weight_constraint_2', api.models.fields.ParameterFloatField(blank=True, default=8.0, model_parameter=api.std_lib.lawm.general_parameters.WeightConstraint2, validators=[api.models.validators.MaxValueParameterValidator(14), api.models.validators.MinValueParameterValidator(1)])),
                ('weight_constraint_3', api.models.fields.ParameterFloatField(blank=True, default=6.0, model_parameter=api.std_lib.lawm.general_parameters.WeightConstraint3, validators=[api.models.validators.MaxValueParameterValidator(14), api.models.validators.MinValueParameterValidator(1)])),
                ('weight_constraint_4', api.models.fields.ParameterFloatField(blank=True, default=6.0, model_parameter=api.std_lib.lawm.general_parameters.WeightConstraint4, validators=[api.models.validators.MaxValueParameterValidator(14), api.models.validators.MinValueParameterValidator(1)])),
                ('weight_constraint_5', api.models.fields.ParameterFloatField(blank=True, default=6.0, model_parameter=api.std_lib.lawm.general_parameters.WeightConstraint5, validators=[api.models.validators.MaxValueParameterValidator(14), api.models.validators.MinValueParameterValidator(1)])),
                ('weight_constraint_6', api.models.fields.ParameterFloatField(blank=True, default=6.0, model_parameter=api.std_lib.lawm.general_parameters.WeightConstraint6, validators=[api.models.validators.MaxValueParameterValidator(14), api.models.validators.MinValueParameterValidator(1)])),
                ('weight_constraint_7', api.models.fields.ParameterFloatField(blank=True, default=4.0, model_parameter=api.std_lib.lawm.general_parameters.WeightConstraint7, validators=[api.models.validators.MaxValueParameterValidator(14), api.models.validators.MinValueParameterValidator(1)])),
                ('weight_constraint_8', api.models.fields.ParameterFloatField(blank=True, default=4.0, model_parameter=api.std_lib.lawm.general_parameters.WeightConstraint8, validators=[api.models.validators.MaxValueParameterValidator(14), api.models.validators.MinValueParameterValidator(1)])),
                ('weight_constraint_9', api.models.fields.ParameterFloatField(blank=True, default=6.0, model_parameter=api.std_lib.lawm.general_parameters.WeightConstraint9, validators=[api.models.validators.MaxValueParameterValidator(14), api.models.validators.MinValueParameterValidator(1)])),
                ('weight_constraint_10', api.models.fields.ParameterFloatField(blank=True, default=6.0, model_parameter=api.std_lib.lawm.general_parameters.WeightConstraint10, validators=[api.models.validators.MaxValueParameterValidator(14), api.models.validators.MinValueParameterValidator(1)])),
                ('weight_constraint_11', api.models.fields.ParameterFloatField(blank=True, default=6.0, model_parameter=api.std_lib.lawm.general_parameters.WeightConstraint11, validators=[api.models.validators.MaxValueParameterValidator(14), api.models.validators.MinValueParameterValidator(1)])),
                ('weight_constraint_12', api.models.fields.ParameterFloatField(blank=True, default=2.0, model_parameter=api.std_lib.lawm.general_parameters.WeightConstraint12, validators=[api.models.validators.MaxValueParameterValidator(14), api.models.validators.MinValueParameterValidator(1)])),
                ('weight_constraint_13', api.models.fields.ParameterFloatField(blank=True, default=4.0, model_parameter=api.std_lib.lawm.general_parameters.WeightConstraint13, validators=[api.models.validators.MaxValueParameterValidator(14), api.models.validators.MinValueParameterValidator(1)])),
                ('weight_constraint_14', api.models.fields.ParameterFloatField(blank=True, default=4.0, model_parameter=api.std_lib.lawm.general_parameters.WeightConstraint14, validators=[api.models.validators.MaxValueParameterValidator(14), api.models.validators.MinValueParameterValidator(1)])),
                ('weight_constraint_15', api.models.fields.ParameterFloatField(blank=True, default=7.0, model_parameter=api.std_lib.lawm.general_parameters.WeightConstraint15, validators=[api.models.validators.MaxValueParameterValidator(14), api.models.validators.MinValueParameterValidator(1)])),
                ('weight_constraint_16', api.models.fields.ParameterFloatField(blank=True, default=4.0, model_parameter=api.std_lib.lawm.general_parameters.WeightConstraint16, validators=[api.models.validators.MaxValueParameterValidator(14), api.models.validators.MinValueParameterValidator(1)])),
                ('weight_constraint_17', api.models.fields.ParameterFloatField(blank=True, default=4.0, model_parameter=api.std_lib.lawm.general_parameters.WeightConstraint17, validators=[api.models.validators.MaxValueParameterValidator(14), api.models.validators.MinValueParameterValidator(1)])),
                ('weight_constraint_18', api.models.fields.ParameterFloatField(blank=True, default=4.0, model_parameter=api.std_lib.lawm.general_parameters.WeightConstraint18, validators=[api.models.validators.MaxValueParameterValidator(14), api.models.validators.MinValueParameterValidator(1)])),
                ('weight_constraint_19', api.models.fields.ParameterFloatField(blank=True, default=8.0, model_parameter=api.std_lib.lawm.general_parameters.WeightConstraint19, validators=[api.models.validators.MaxValueParameterValidator(14), api.models.validators.MinValueParameterValidator(1)])),
                ('weight_constraint_20', api.models.fields.ParameterFloatField(blank=True, default=6.0, model_parameter=api.std_lib.lawm.general_parameters.WeightConstraint20, validators=[api.models.validators.MaxValueParameterValidator(14), api.models.validators.MinValueParameterValidator(1)])),
                ('weight_constraint_21', api.models.fields.ParameterFloatField(blank=True, default=4.0, model_parameter=api.std_lib.lawm.general_parameters.WeightConstraint21, validators=[api.models.validators.MaxValueParameterValidator(14), api.models.validators.MinValueParameterValidator(1)])),
                ('weight_constraint_22', api.models.fields.ParameterFloatField(blank=True, default=6.0, model_parameter=api.std_lib.lawm.general_parameters.WeightConstraint22, validators=[api.models.validators.MaxValueParameterValidator(14), api.models.validators.MinValueParameterValidator(1)])),
                ('weight_constraint_23', api.models.fields.ParameterFloatField(blank=True, default=8.0, model_parameter=api.std_lib.lawm.general_parameters.WeightConstraint23, validators=[api.models.validators.MaxValueParameterValidator(14), api.models.validators.MinValueParameterValidator(1)])),
                ('weight_constraint_24', api.models.fields.ParameterFloatField(blank=True, default=6.0, model_parameter=api.std_lib.lawm.general_parameters.WeightConstraint24, validators=[api.models.validators.MaxValueParameterValidator(14), api.models.validators.MinValueParameterValidator(1)])),
                ('weight_constraint_25', api.models.fields.ParameterFloatField(blank=True, default=2.0, model_parameter=api.std_lib.lawm.general_parameters.WeightConstraint25, validators=[api.models.validators.MaxValueParameterValidator(14), api.models.validators.MinValueParameterValidator(1)])),
                ('weight_constraint_26', api.models.fields.ParameterFloatField(blank=True, default=1.0, model_parameter=api.std_lib.lawm.general_parameters.WeightConstraint26, validators=[api.models.validators.MaxValueParameterValidator(14), api.models.validators.MinValueParameterValidator(1)])),
            ],
        ),
        migrations.CreateModel(
            name='LAWMRegion',
